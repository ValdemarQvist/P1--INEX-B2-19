...
The purpose of this project is to create a robot which can map the area, make a path, avoid obstacles on its own and to make the robot more autonomous than the previous robots. %Furthermore, the design of the robot has to be just as durable or more than the current solutions.\\
